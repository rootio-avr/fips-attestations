#!/bin/bash
################################################################################
# SLSA Attestation Generator for ubuntu-fips-java
#
...
ATTESTATION_OUTPUT="slsa-provenance-ubuntu-fips-java-v1.0.0.json"
...
cat > "$ATTESTATION_OUTPUT" <<EOF
{
  ...
  "predicate": {
    ...
    "runDetails": {
      ...
      "byproducts": [
        {
          "uri": "sbom-ubuntu-fips-java-v1.0.0.spdx.json",
          "name": "SBOM",
          "mediaType": "application/spdx+json"
        },
        {
          "uri": "vex-ubuntu-fips-java-v1.0.0.json",
          "name": "VEX",
