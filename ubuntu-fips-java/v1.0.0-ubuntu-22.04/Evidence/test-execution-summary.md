# Test Execution Summary - ubuntu-fips-java
...
This document summarizes all test executions performed against the ubuntu-fips-java container image
...
```bash
# Clone repository
git clone <repo-url> && cd fips-poc/ubuntu-fips-java/v1.0.0-ubuntu-22.04
