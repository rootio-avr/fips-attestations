...
# Output: slsa-provenance-java-21-jdk-jammy-ubuntu-22.04-fips
```
...
```json
{
  ...
  "subject": [
    {
      "name": "java:21-jdk-jammy-ubuntu-22.04-fips",
      "digest": {
        "sha256": "..."
      }
    }
  ...
  "predicate": {
    ...
    "materials": [
      {
        "uri": "pkg:docker/eclipse-temurin@21-jdk-jammy",
        "digest": {"sha256": "..."}
      }
    ]
  }
...
# Output: SBOM-java-21-jdk-jammy-ubuntu-22.04-fips.spdx.json
```
...
# Output: vex-java-21-jdk-jammy-ubuntu-22.04-fips.json
```
...
Target: java:21-jdk-jammy-ubuntu-22.04-fips
...
- Base Image: eclipse-temurin:21-jdk-jammy@sha256:...
