...
**Image:** cr.root.io/java:21-jdk-jammy-ubuntu-22.04-fips
...
- ✅ Java runtime available: `openjdk version "21.0.2" 2024-01-16`
...
| Metric | Value | Notes |
|--------|-------|-------|
| Image Size | ~800 MB | Includes OpenJDK 21 JDK + wolfSSL FIPS + JNI libraries (linux/amd64) |
...
```bash
# Clone repository
git clone <repo-url> && cd fips-poc/java/21-jdk-jammy-ubuntu-22.04-fips
