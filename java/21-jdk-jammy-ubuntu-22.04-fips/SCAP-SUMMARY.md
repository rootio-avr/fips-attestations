# SCAP Scan Summary - java:21-jdk-jammy-ubuntu-22.04-fips

**Scan Date:** 2026-03-04
**Scanner:** OpenSCAP 1.3.9
**Profile:** DISA STIG Baseline (Container-Adapted for Ubuntu Jammy)
**Image:** java:21-jdk-jammy-ubuntu-22.04-fips (OpenJDK 21 / Ubuntu Jammy)
...
# Image signature
cosign verify java:21-jdk-jammy-ubuntu-22.04-fips
```
...
- `scripts/integrity-check.sh`
- `compliance/sbom-java-21-jdk-jammy-ubuntu-22.04-fips.spdx.json`
...
docker inspect java:21-jdk-jammy-ubuntu-22.04-fips | grep User
...
docker run -d --name fips-java-scan java:21-jdk-jammy-ubuntu-22.04-fips tail -f /dev/null
