...
| **Operating Environment** | ✅ Compliant | Container environment (Ubuntu 22.04 LTS) |
...
# Output: slsa-provenance-java-17-jammy-ubuntu-22.04-fips.json
```
...
```json
{
  ...
  "subject": [
    {
      "name": "java:17-jammy-ubuntu-22.04-fips",
      "digest": {
        "sha256": "..."
      }
    }
...
# Output: sbom-java-17-jammy-ubuntu-22.04-fips.spdx.json
```
...
# Output: vex-java-17-jammy-ubuntu-22.04-fips.json
```
  ...
  "statements": [
    {
      ...
      "products": ["java:17-jammy-ubuntu-22.04-fips"],
      "status": "not_affected",
...
Target: java:17-jammy-ubuntu-22.04-fips
...
**Version**: java:17-jammy-ubuntu-22.04-fips
