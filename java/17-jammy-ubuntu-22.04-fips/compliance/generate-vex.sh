  ...
  "statements": [
    {
      ...
      "impact_statement": "This image uses wolfSSL FIPS v5.8.2 (Certificate #4718) as the primary cryptographic backend via wolfProvider. System OpenSSL 3.0.2 is present but cryptographic operations route through wolfSSL in FIPS mode."
    },
    {
      "vulnerability": {
