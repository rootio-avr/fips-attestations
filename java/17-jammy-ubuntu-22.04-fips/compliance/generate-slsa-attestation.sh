#!/bin/bash
################################################################################
# SLSA Attestation Generator for java
#
...
ATTESTATION_OUTPUT="slsa-provenance-java-17-jammy-ubuntu-22.04-fips.json"
...
cat > "$ATTESTATION_OUTPUT" <<EOF
{
  ...
  "predicate": {
    ...
    "runDetails": {
      ...
      "byproducts": [
        {
          "uri": "sbom-java-17-jammy-ubuntu-22.04-fips.spdx.json",
          "name": "SBOM",
          "mediaType": "application/spdx+json"
        },
        {
          "uri": "vex-java-17-jammy-ubuntu-22.04-fips.json",
          "name": "VEX",
