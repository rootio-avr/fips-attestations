...
docker run --rm -it \
  ...
  java:11-jdk-jammy-ubuntu-22.04-fips bash
...
- **[Java KeyStore Documentation](https://docs.oracle.com/en/java/javase/11/security/java-pki-programmers-guide.html)** - Oracle KeyStore guide
