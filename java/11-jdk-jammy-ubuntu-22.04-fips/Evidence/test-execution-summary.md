...
- ✅ Java runtime available: `openjdk version "11.0.22" 2024-01-16`
...
| Metric | Value | Notes |
|--------|-------|-------|
| Image Size | ~800 MB | Includes OpenJDK 11 JDK + wolfSSL FIPS + JNI libraries (linux/amd64) |
...
```bash
# Clone repository
git clone <repo-url> && cd fips-poc/java/11-jdk-jammy-ubuntu-22.04-fips
