# SCAP Scan Summary - java:11-jdk-jammy-ubuntu-22.04-fips

**Scan Date:** 2026-03-04
**Scanner:** OpenSCAP 1.3.9
**Profile:** DISA STIG Baseline (Container-Adapted for Ubuntu Jammy)
**Image:** java:11-jdk-jammy-ubuntu-22.04-fips (OpenJDK 11 / Ubuntu Jammy)
...
# SBOM presence
ls compliance/sbom-java-11-jdk-jammy-ubuntu-22.04-fips.spdx.json

# Image signature
cosign verify java:11-jdk-jammy-ubuntu-22.04-fips
```
...
- `scripts/integrity-check.sh`
- `compliance/sbom-java-11-jdk-jammy-ubuntu-22.04-fips.spdx.json`
...
docker inspect java:11-jdk-jammy-ubuntu-22.04-fips | grep User

# Verify at runtime
docker run --rm java:11-jdk-jammy-ubuntu-22.04-fips id
```
...
docker run -d --name fips-java-scan java:11-jdk-jammy-ubuntu-22.04-fips tail -f /dev/null
