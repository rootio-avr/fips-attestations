# Chain of Custody: java:11-jdk-jammy-ubuntu-22.04-fips

## Document Information
- **Image Name**: java
- **Version**: 11-jdk-jammy-ubuntu-22.04-fips
- **Date**: 2026-03-04
...
- **Build Command**:
  ```bash
  DOCKER_BUILDKIT=1 docker build -t java:11-jdk-jammy-ubuntu-22.04-fips \
...
- **Build Stages**:
  ...
  6. Runtime: Final minimal image with OpenJDK 11 and wolfSSL providers
...
4. **Java Application Compilation**:
   ...
   - Compiled with OpenJDK 11 compiler (`javac`)
...
### 2.3 Build Artifacts
- **Container Image**: `java:11-jdk-jammy-ubuntu-22.04-fips`
- **SBOM**: `SBOM-java-11-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **VEX**: `vex-java-11-jdk-jammy-ubuntu-22.04-fips.json`
...
- **File**: `SBOM-java-11-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **Format**: SPDX 2.3
...
- **File**: `vex-java-11-jdk-jammy-ubuntu-22.04-fips.json`
