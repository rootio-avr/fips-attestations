...
public class KeyStoreFormatDemo {
    ...
    private static void testTLSWithWKS() {
        ...
        try {
            ...
            // Check if this is a certificate verification error and we're on Java 11
            String javaVersion = System.getProperty("java.version");
            boolean isJava11 = javaVersion != null && javaVersion.startsWith("11.");
            boolean isCertVerifyError = e.getMessage() != null &&
                (e.getMessage().contains("verify problem") ||
                 e.getMessage().contains("error code: -329"));

            if (isJava11 && isCertVerifyError) {
                System.out.println("  ⚠️  Java 11 TLS limitation - certificate verification issue");
                System.out.println("    Error: " + e.getMessage());
                System.out.println("    Note: This is a known Java 11 limitation with certain EC certificates");
