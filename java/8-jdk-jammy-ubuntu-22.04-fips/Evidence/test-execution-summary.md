...
**Image:** cr.root.io/java:8-jdk-jammy-ubuntu-22.04-fips
...
- ✅ Java runtime available: `openjdk version "1.8.0_402"`
...
| Metric | Value | Notes |
|--------|-------|-------|
| Image Size | ~800 MB | Includes OpenJDK 8 JDK + wolfSSL FIPS + JNI libraries (linux/amd64) |
...
```bash
# Clone repository
git clone <repo-url> && cd fips-poc/java/8-jdk-jammy-ubuntu-22.04-fips
