# Chain of Custody: java:8-jdk-jammy-ubuntu-22.04-fips

## Document Information
- **Image Name**: java
- **Version**: 8-jdk-jammy-ubuntu-22.04-fips
- **Date**: 2026-03-04
...
### 1.1 Base Image
- **Component**: Ubuntu 22.04 (Jammy) with OpenJDK 8
- **Source**: `eclipse-temurin:8-jdk-jammy`
...
- **Build Command**:
  ```bash
  DOCKER_BUILDKIT=1 docker build -t java:8-jdk-jammy-ubuntu-22.04-fips \
...
- **Build Stages**:
  ...
  6. Runtime: Final minimal image with OpenJDK 8 and wolfSSL providers
...
4. **Java Application Compilation**:
   ...
   - Compiled with OpenJDK 8 compiler (`javac`)
...
### 2.3 Build Artifacts
- **Container Image**: `java:8-jdk-jammy-ubuntu-22.04-fips`
- **SBOM**: `SBOM-java-8-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **VEX**: `vex-java-8-jdk-jammy-ubuntu-22.04-fips.json`
...
- **File**: `SBOM-java-8-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **Format**: SPDX 2.3
...
- **File**: `vex-java-8-jdk-jammy-ubuntu-22.04-fips.json`
