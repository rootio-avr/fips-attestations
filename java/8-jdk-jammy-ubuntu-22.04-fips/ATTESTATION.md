...
# Output: slsa-provenance-java-8-jdk-jammy-ubuntu-22.04-fips
```
...
```json
{
  ...
  "subject": [
    {
      "name": "java:8-jdk-jammy-ubuntu-22.04-fips",
      "digest": {
        "sha256": "..."
      }
    }
  ...
  "predicate": {
    ...
    "materials": [
      {
        "uri": "pkg:docker/eclipse-temurin@8-jdk-jammy",
        "digest": {"sha256": "..."}
      }
    ]
  }
...
# Output: SBOM-java-8-jdk-jammy-ubuntu-22.04-fips.spdx.json
```
...
# Output: vex-java-8-jdk-jammy-ubuntu-22.04-fips.json
```
  ...
  "statements": [
    {
      ...
      "products": ["java:8-jdk-jammy-ubuntu-22.04-fips"],
      "status": "not_affected",
...
Target: java:8-jdk-jammy-ubuntu-22.04-fips
...
- Base Image: eclipse-temurin:8-jdk-jammy@sha256:...
...
**Version**: java:8-jdk-jammy-ubuntu-22.04-fips
