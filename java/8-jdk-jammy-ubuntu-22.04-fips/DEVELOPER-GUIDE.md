...
**Location**: `$JAVA_HOME/jre/lib/security/java.security`
...
docker run --rm -it \
  ...
  java:8-jdk-jammy-ubuntu-22.04-fips bash
...
4. **Inspect Configuration**:
   ```bash
   docker run --rm java:8-jdk-jammy-ubuntu-22.04-fips bash -c \
     "cat \$JAVA_HOME/jre/lib/security/java.security | grep security.provider"
   ```
...
- **[Java Security Documentation](https://docs.oracle.com/en/java/javase/8/security/)** - Oracle JCA/JSSE docs
