...
**Configuration File**: `$JAVA_HOME/jre/lib/security/java.security`
...
FROM eclipse-temurin:8-jdk-jammy AS filtered-providers-builder
...
FROM eclipse-temurin:8-jdk-jammy AS app-builder
