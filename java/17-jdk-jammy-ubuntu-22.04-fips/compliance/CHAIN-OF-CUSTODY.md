# Chain of Custody: java:17-jdk-jammy-ubuntu-22.04-fips

## Document Information
- **Image Name**: java
- **Version**: 17-jdk-jammy-ubuntu-22.04-fips
- **Date**: 2026-03-04
...
### 1.1 Base Image
- **Component**: Ubuntu 22.04 (Jammy) with OpenJDK 17
- **Source**: `eclipse-temurin:17-jdk-jammy`
...
- **Build Command**:
  ```bash
  DOCKER_BUILDKIT=1 docker build -t java:17-jdk-jammy-ubuntu-22.04-fips \
...
- **Build Stages**:
  ...
  6. Runtime: Final minimal image with OpenJDK 17 and wolfSSL providers
...
### 2.3 Build Artifacts
- **Container Image**: `java:17-jdk-jammy-ubuntu-22.04-fips`
- **SBOM**: `SBOM-java-17-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **VEX**: `vex-java-17-jdk-jammy-ubuntu-22.04-fips.json`
...
- **File**: `SBOM-java-17-jdk-jammy-ubuntu-22.04-fips.spdx.json`
- **Format**: SPDX 2.3
...
- **File**: `vex-java-17-jdk-jammy-ubuntu-22.04-fips.json`
