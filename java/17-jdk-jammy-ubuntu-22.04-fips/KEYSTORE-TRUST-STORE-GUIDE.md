...
docker run --rm -it \
  ...
  java:17-jdk-jammy-ubuntu-22.04-fips bash
...
- **[Java KeyStore Documentation](https://docs.oracle.com/en/java/javase/17/security/java-pki-programmers-guide.html)** - Oracle KeyStore guide
