...
# Default values
IMAGE_NAME="java-17-jdk-jammy-ubuntu-22.04-fips-demos"
TAG="latest"
VERBOSE=false
NO_CACHE=false
BASE_IMAGE="cr.root.io/java:17-jdk-jammy-ubuntu-22.04-fips"
...
EXAMPLES:
  ...
  $0 -b cr.root.io/java:17-jdk-jammy-ubuntu-22.04-fips:custom -v   # Custom base image with verbose output
