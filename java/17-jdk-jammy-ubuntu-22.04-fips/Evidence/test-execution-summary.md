...
**Image:** cr.root.io/java:17-jdk-jammy-ubuntu-22.04-fips
...
- ✅ Java runtime available: `openjdk version "17.0.10" 2024-01-16`
...
| Metric | Value | Notes |
|--------|-------|-------|
| Image Size | ~800 MB | Includes OpenJDK 17 JDK + wolfSSL FIPS + JNI libraries (linux/amd64) |
...
```bash
# Clone repository
git clone <repo-url> && cd fips-poc/java/17-jdk-jammy-ubuntu-22.04-fips
