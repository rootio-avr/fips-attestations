# SCAP Scan Summary - java:19-jdk-bookworm-slim-fips

**Scan Date:** 2026-03-04
**Scanner:** OpenSCAP 1.3.9
**Profile:** DISA STIG Baseline (Container-Adapted for Debian Bookworm)
**Image:** java:19-jdk-bookworm-slim-fips (OpenJDK 19 / Debian Bookworm)
...
# SBOM presence
ls compliance/sbom-java-19-jdk-bookworm-slim-fips.spdx.json

# Image signature
cosign verify java:19-jdk-bookworm-slim-fips
```
...
- `scripts/integrity-check.sh`
- `compliance/sbom-java-19-jdk-bookworm-slim-fips.spdx.json`
...
docker inspect java:19-jdk-bookworm-slim-fips | grep User

# Verify at runtime
docker run --rm java:19-jdk-bookworm-slim-fips id
```
...
docker run -d --name fips-java-scan java:19-jdk-bookworm-slim-fips tail -f /dev/null
