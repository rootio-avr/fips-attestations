...
docker run --rm -it \
  ...
  java:19-jdk-bookworm-slim-fips bash
...
- **[Java KeyStore Documentation](https://docs.oracle.com/en/java/javase/19/security/java-pki-programmers-guide.html)** - Oracle KeyStore guide
