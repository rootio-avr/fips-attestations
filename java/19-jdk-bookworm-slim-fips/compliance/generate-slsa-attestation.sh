...
ATTESTATION_OUTPUT="slsa-provenance-java-19-jdk-bookworm-slim-fips.json"
...
cat > "$ATTESTATION_OUTPUT" <<EOF
{
  ...
  "predicate": {
    ...
    "runDetails": {
      ...
      "byproducts": [
        {
          "uri": "sbom-java-19-jdk-bookworm-slim-fips.spdx.json",
          "name": "SBOM",
          "mediaType": "application/spdx+json"
        },
        {
          "uri": "vex-java-19-jdk-bookworm-slim-fips.json",
          "name": "VEX",
