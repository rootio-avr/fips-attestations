#!/bin/bash
################################################################################
# Package Installation Script - Nginx FIPS Builder Stage
#
...
# Package list for builder stage
PACKAGES="zlib1g libsqlite3-0 build-essential ca-certificates curl git autoconf automake libtool pkg-config p7zip-full perl libpcre3-dev zlib1g-dev"

echo "================================================================================"
echo "Installing Builder Stage Packages for Nginx FIPS"
echo "================================================================================"
...
echo "================================================================================"
echo "✓ Builder Stage Package Installation Complete"
echo "================================================================================"
