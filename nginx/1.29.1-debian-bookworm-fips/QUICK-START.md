# Nginx 1.29.1 FIPS - Quick Start Guide
...
4. Downloads and compiles Nginx 1.29.1 with wolfSSL
5. Creates minimal runtime image

**Expected output:**
```
[INFO] Build completed successfully in 1234s
✓ Nginx version verified: 1.29.1
...
# Run
docker run -d -p 80:80 -p 443:443 cr.root.io/nginx:1.29.1-debian-bookworm-fips
