# Test Execution Summary - Nginx 1.27.3 FIPS
...
This document summarizes all test executions performed against the Nginx 1.27.3 wolfSSL FIPS container image
...
**Environment:** Nginx 1.27.3 with wolfSSL FIPS 5.8.2 (Certificate #4718)
...
**Execution:**
```bash
docker run -d -p 443:443 --name nginx-fips cr.root.io/nginx:1.27.3-debian-bookworm-fips
...
The Nginx 1.27.3 wolfSSL FIPS image has successfully completed all validation tests and is ready for production deployment in FIPS 140-3 compliant environments.
