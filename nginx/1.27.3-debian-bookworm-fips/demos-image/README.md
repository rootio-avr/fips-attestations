...
Interactive demonstration image showcasing Nginx 1.27.3 with wolfSSL FIPS 140-3 in real-world scenarios.

## Overview

This demo image extends `cr.root.io/nginx:1.27.3-debian-bookworm-fips` with four production-ready configuration examples:
...
**Prerequisites:**
- Base image must exist: `cr.root.io/nginx:1.27.3-debian-bookworm-fips`
