...
Comprehensive test image for validating Nginx 1.27.3 with wolfSSL FIPS 140-3 integration.

## Overview

This test image extends the base `cr.root.io/nginx:1.27.3-debian-bookworm-fips` image with comprehensive test suites to validate FIPS compliance in a user application context.
