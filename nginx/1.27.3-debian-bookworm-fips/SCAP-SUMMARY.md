# SCAP Scan Summary - nginx:1.27.3-debian-bookworm-fips

**Scan Date:** 2026-03-25
**Scanner:** OpenSCAP 1.3.9
**Profile:** DISA STIG Baseline (Container-Adapted for Debian Bookworm)
**Image:** nginx:1.27.3-debian-bookworm-fips (Nginx 1.27.3 / Debian Bookworm)
...
# SBOM presence
ls supply-chain/SBOM-nginx-1.27.3-debian-bookworm-fips.spdx.json

# Image signature
cosign verify nginx:1.27.3-debian-bookworm-fips
...
- VEX statement: Available (supply-chain/vex-nginx-1.27.3-debian-bookworm-fips.json)
- SLSA provenance: Available (supply-chain/slsa-provenance-nginx-1.27.3-debian-bookworm-fips.json)
...
**Evidence Files:**
- `supply-chain/SBOM-nginx-1.27.3-debian-bookworm-fips.spdx.json`
- `supply-chain/vex-nginx-1.27.3-debian-bookworm-fips.json`
- `supply-chain/slsa-provenance-nginx-1.27.3-debian-bookworm-fips.json`
...
docker inspect nginx:1.27.3-debian-bookworm-fips | grep User
```
...
| **SBOM** | `supply-chain/SBOM-nginx-1.27.3-debian-bookworm-fips.spdx.json` | Software Bill of Materials |
| **VEX** | `supply-chain/vex-nginx-1.27.3-debian-bookworm-fips.json` | Vulnerability disclosure |
| **SLSA** | `supply-chain/slsa-provenance-nginx-1.27.3-debian-bookworm-fips.json` | Build provenance |
