#!/bin/bash
################################################################################
# Ubuntu FIPS Go - Diagnostic Runner
#
# Purpose: Execute FIPS validation diagnostics
# Usage:
#   ./diagnostic.sh                    # Run all diagnostics
#   ./diagnostic.sh test-name.sh      # Run specific diagnostic
################################################################################
...
IMAGE_NAME="cr.root.io/golang:1.25-jammy-ubuntu-22.04-fips"
DIAGNOSTICS_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/diagnostics"

echo ""
echo "================================================================================"
echo -e "${BOLD}${CYAN}Ubuntu FIPS Go - Diagnostic Runner${NC}"
echo "================================================================================"
echo ""
