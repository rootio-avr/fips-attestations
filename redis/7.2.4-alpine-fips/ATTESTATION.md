...
| **SLSA Provenance** | `compliance/slsa-provenance-redis-7.2.4-alpine-fips.json` | Build attestation |
| **VEX** | `compliance/vex-redis-7.2.4-alpine-fips.json` | Vulnerability exploitability |
...
1. The Redis 7.2.4 Alpine FIPS image (`cr.root.io/redis:7.2.4-alpine-fips`) incorporates the wolfSSL FIPS v5.8.2 cryptographic module (CMVP Certificate #4718).
...
# Check wolfProvider
docker run --rm cr.root.io/redis:7.2.4-alpine-fips openssl list -providers
