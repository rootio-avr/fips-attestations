...
- VEX statement: Available (compliance/vex-redis-7.2.4-alpine-fips.json)
- SLSA provenance: Available (compliance/slsa-provenance-redis-7.2.4-alpine-fips.json)
...
**Evidence Files:**
- `compliance/SBOM-redis-7.2.4-alpine-fips.spdx.json`
- `compliance/vex-redis-7.2.4-alpine-fips.json`
- `compliance/slsa-provenance-redis-7.2.4-alpine-fips.json`
...
| **SBOM** | `compliance/SBOM-redis-7.2.4-alpine-fips.spdx.json` | Software Bill of Materials |
| **VEX** | `compliance/vex-redis-7.2.4-alpine-fips.json` | Vulnerability disclosure |
| **SLSA** | `compliance/slsa-provenance-redis-7.2.4-alpine-fips.json` | Build provenance |
