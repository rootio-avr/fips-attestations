...
jobs:
  build:
    ...
    steps:
      ...
      - name: Push image
        if: github.ref == 'refs/heads/main'
        run: docker push cr.root.io/redis:7.2.4-alpine-fips

      - name: Generate SBOM
        if: github.ref == 'refs/heads/main'
        run: |
          syft cr.root.io/redis:7.2.4-alpine-fips \
            -o spdx-json > compliance/SBOM-redis-7.2.4-alpine-fips.spdx.json
```
...
push:
  ...
  script:
    ...
    - docker push cr.root.io/redis:7.2.4-alpine-fips
```
