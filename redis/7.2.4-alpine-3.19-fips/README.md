...
docker run -e FIPS_CHECK=false -d -p 6379:6379 \
  --name redis-fips cr.root.io/redis:7.2.4-alpine-3.19-fips
```
...
- **SBOM:** See [compliance/SBOM-redis-7.2.4-alpine-3.19-fips.spdx.json](compliance/SBOM-redis-7.2.4-alpine-3.19-fips.spdx.json)
- **SLSA Provenance:** See [compliance/slsa-provenance-redis-7.2.4-alpine-3.19-fips.json](compliance/slsa-provenance-redis-7.2.4-alpine-3.19-fips.json)
- **VEX:** See [compliance/vex-redis-7.2.4-alpine-3.19-fips.json](compliance/vex-redis-7.2.4-alpine-3.19-fips.json)
...
*Image version: 7.2.4-alpine-3.19-fips*
