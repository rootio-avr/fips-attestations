...
This demo image extends `cr.root.io/redis:7.2.4-alpine-3.19-fips` with five production-ready configuration examples:
...
**Prerequisites:**
- Base image must exist: `cr.root.io/redis:7.2.4-alpine-3.19-fips`
