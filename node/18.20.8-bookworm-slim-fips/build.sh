#!/bin/bash
################################################################################
# Node.js 18 Bookworm FIPS - Build Script
#
# Purpose: Build Node.js 18 container with wolfSSL FIPS 140-3 support
# Usage:
...
# Build configuration
IMAGE_NAME="node"
IMAGE_TAG="18.20.8-bookworm-slim-fips"
...
echo ""
echo "================================================================================"
echo -e "${BOLD}${CYAN}Node.js 18 with wolfSSL FIPS 140-3 - Build Script${NC}"
echo "================================================================================"
echo ""
