...
Comprehensive test image for validating Node.js 16 with wolfSSL FIPS 140-3 integration.

## Overview

This test image extends the base `node:16.20.1-bookworm-slim-fips` image with comprehensive test suites to validate FIPS compliance in a user application context.
