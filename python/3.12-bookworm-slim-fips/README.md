# Python 3.12 with wolfSSL FIPS 140-3

Production-ready Docker image for Python 3.12 with wolfSSL FIPS 140-3 (Certificate #4718) cryptographic module.

## Overview

This container provides Python 3.12 on Debian Bookworm with wolfSSL FIPS 140-3 as the cryptographic provider, replacing OpenSSL for all SSL/TLS operations. The implementation uses wolfProvider to integrate wolfSSL as the default OpenSSL provider system-wide.

### Key Features

✅ **FIPS 140-3 Compliant** - wolfSSL 5.8.2 FIPS (Certificate #4718)
✅ **Python 3.12** - Latest stable Python with wolfSSL integration
...
2. **Python Version**: Only Python 3.12 is currently supported
