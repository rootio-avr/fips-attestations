...
The image is built on **Debian Bookworm Slim** with **Python 3.12** and integrates **wolfSSL FIPS v5.8.2 (Certificate #4718)** through **wolfProvider v1.0.2**, providing cryptographic FIPS enforcement at the OpenSSL provider layer without requiring OS-level kernel FIPS mode.
...
```bash
# Build demos image
cd python/3.12-bookworm-slim-fips/demos-image
./build.sh
...
```
================================================================================
Running Diagnostic Test Suite for Python 3.12 FIPS
================================================================================
...
| **Python runtime** | `test-backend-verification.py` | Python 3.12.x |
...
| Application Runtime | Language FIPS support | ✅ Python 3.12 ssl module via OpenSSL 3.0.18 |
...
|------|--------|----------|----------|
| `SBOM-python-3.12-bookworm-slim-fips.spdx.json` | JSON | SPDX 2.3 | `compliance/` |
| `vex-python-3.12-bookworm-slim-fips.json` | JSON | OpenVEX v0.2.0 | `compliance/` |
| `slsa-provenance-python-3.12-bookworm-slim-fips.json` | JSON | SLSA v1.0 | `compliance/` |
...
cd python/3.12-bookworm-slim-fips/compliance
./generate-sbom.sh
...
| **Python** | 3.12.x | N/A (runtime) | ✅ ssl module uses OpenSSL |
