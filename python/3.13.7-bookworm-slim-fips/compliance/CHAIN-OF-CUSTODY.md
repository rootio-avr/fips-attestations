# Chain of Custody: python:3.13.7-bookworm-slim-fips

## Document Information
- **Image Name**: python
- **Version**: 3.13.7-bookworm-slim-fips
- **Date**: 2026-03-21
...
### 1.1 Base Image
- **Component**: Python 3.13.7 on Debian Bookworm (Slim)
- **Source**: `debian:bookworm-slim` (Python 3.13.7 built from source)
...
- **Build Command**:
  ```bash
  DOCKER_BUILDKIT=1 docker build -t python:3.13.7-bookworm-slim-fips \
    --secret id=wolfssl_password,src=wolfssl_password.txt .
  ```
- **Build Stages**:
  1. base: Python 3.13.7 slim with build tools and dependencies
  ...
  5. runtime: Final minimal image with Python 3.13.7 and wolfSSL FIPS provider
...
### 2.3 Build Artifacts
- **Container Image**: `python:3.13.7-bookworm-slim-fips`
- **SBOM**: `SBOM-python-3.13.7-bookworm-slim-fips.spdx.json`
- **VEX**: `vex-python-3.13.7-bookworm-slim-fips.json`
...
- **File**: `SBOM-python-3.13.7-bookworm-slim-fips.spdx.json`
- **Format**: SPDX 2.3
...
- **Verification**: `python3 -c "import json; json.load(open('SBOM-python-3.13.7-bookworm-slim-fips.spdx.json'))"`

### 4.2 VEX Traceability
- **File**: `vex-python-3.13.7-bookworm-slim-fips.json`
