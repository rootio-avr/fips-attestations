# SCAP Scan Summary - python:3.13.7-bookworm-slim-fips

**Scan Date:** 2026-03-21
**Scanner:** OpenSCAP 1.3.9
**Profile:** DISA STIG Baseline (Container-Adapted for Debian Bookworm)
**Image:** python:3.13.7-bookworm-slim-fips (Python 3.13.7 / Debian Bookworm)
...
# SBOM presence
ls compliance/SBOM-python-3.13.7-bookworm-slim-fips.spdx.json

# Image signature
cosign verify python:3.13.7-bookworm-slim-fips
...
- VEX statement: Available (compliance/vex-python-3.13.7-bookworm-slim-fips.json)
- Test suite: 5/5 diagnostic test suites passed (100%)

**Evidence Files:**
- `/opt/wolfssl-fips/checksums/libraries.sha256`
- `scripts/integrity-check.sh`
- `compliance/SBOM-python-3.13.7-bookworm-slim-fips.spdx.json`
- `compliance/vex-python-3.13.7-bookworm-slim-fips.json`
...
docker inspect python:3.13.7-bookworm-slim-fips | grep User

# Verify at runtime
docker run --rm python:3.13.7-bookworm-slim-fips id
```
...
docker run -d --name fips-python-scan python:3.13.7-bookworm-slim-fips tail -f /dev/null
