...
This directory contains supply chain security documentation and verification tools for the Gotenberg 8.30.0 Debian Trixie FIPS container image.
...
curl -LO https://cr.root.io/gotenberg/8.30.0-trixie-slim-fips/cosign.pub
