# Gotenberg 8.30.0 Debian Trixie FIPS - Architecture
...
This document describes the technical architecture of the Gotenberg 8.30.0 Debian Trixie FIPS image, focusing on how FIPS 140-3 compliance is achieved while maintaining full Gotenberg PDF generation functionality.

### High-Level Architecture

```
┌──────────────────────────────────────────────────────────────────┐
│             Gotenberg 8.30.0 Application Layer                   │
│  ┌────────────────┐  ┌────────────────┐  ┌────────────────┐     │
...
#### 1. Application Layer (Gotenberg 8.30.0)
...
1. **Clone Gotenberg source**
   ```bash
   git clone https://github.com/gotenberg/gotenberg.git --branch v8.30.0
   ```
