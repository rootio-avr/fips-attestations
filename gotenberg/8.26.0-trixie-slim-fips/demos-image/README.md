...
This creates: `gotenberg-demos:8.26.0-trixie-slim-fips`
...
**Run**:
```bash
docker run --rm gotenberg-demos:8.26.0-trixie-slim-fips /demos/fips-verification/run.sh
```
...
docker run --rm --network gotenberg-demo-net \
  ...
  gotenberg-demos:8.26.0-trixie-slim-fips \
...
- [OPENSSL-VERIFICATION.md](../OPENSSL-VERIFICATION.md) - Runtime verification
