...
This document attests to the FIPS 140-3 compliance of the Gotenberg 8.26.0 Debian Trixie FIPS container image. The image incorporates the wolfSSL FIPS cryptographic module (CMVP Certificate #4718) and has been validated to meet FIPS 140-3 requirements for cryptographic operations.
...
This document formally attests that the Gotenberg 8.26.0 Debian Trixie FIPS container image:
...
Gotenberg 8.26.0 Debian Trixie FIPS container image as of
